...
public class WalletDto {
    ...
    @NotBlank(message = "Name is required as it musn't be blank.")
    @Pattern(regexp = "[a-zA-Z]{5,20}", message = "Name should contain 5 - 20 character and no special characters allowed")
    private String name;
